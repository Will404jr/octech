        ...
        <div class="container">
            <div class="row">
                <div class="col s12 m12 l12">
                    <h5 class="breadcrumbs-title col s5"><b>{{__('messages.rate_page.edit_rate')}}</b></h5>
            ...
            <div class="row">
                <div class="col s12 m12 l12  offset-m1">
                    <div class="card-panel">
                        <div class="row">
                            <form id="rate_form" method="post" action="{{route('rates.update',[$rate->id])}}">
                                {{@csrf_field()}}
                                {{method_field('PATCH')}}
                                <div class="row">
                                    <div class="row form_align">
                                        <div class="input-field col s10">
                                            <select name="country_name" id="country_name">
                                                ...
                                                @foreach ($countries as $country)
                                                    <option value="{{$country->code}}" {{ ($rate->country_code == $country->countryCode) ? 'selected' : '' }}>{{$country->country}} </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <input name="country_flag_text" type="hidden" value = "{{ $rate->country_flag }}" id="country_flag_text">

                                    </div>
                                    <div class="row form_align">
                                        <div class="input-field col s6">
                                            <label id = "country_code_label" for="country_code">{{__('messages.rate_page.country_code')}}</label>
                                            <input id="country_code" name="country_code" type="text" value="{{ $rate->country_code }}" data-error=".country_code" readonly>
                                        ...
                                        <div class="input-field col s6">
                                            ...
                                            <input id="currency_code" name="currency_code" type="text" value="{{ $rate->currency_code }}" data-error=".currency_code" readonly>
                                    ...
                                    <div class="row form_align">
                                        <div class="input-field col s6">
                                            ...
                                            <input id="buying_rate" name="buying_rate" type="number" value="{{ $rate->buying_rate }}" data-error=".buying_rate">
                                        ...
                                        <div class="input-field col s6">
                                            ...
                                            <input id="selling_rate" name="selling_rate" type="number" value="{{ $rate->selling_rate }}" data-error=".selling_rate">
