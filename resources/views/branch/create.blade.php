        ...
        <div class="container">
            <div class="row">
                <div class="col s12 m12 l12">
                    <h5 class="breadcrumbs-title col s5"><b>{{__('messages.branch_page.add branch')}}</b></h5>
            ...
            <div class="row">
                <div class="col s12 m12 l12  offset-m1">
                    <div class="card-panel">
                        <div class="row">
                            <form id="branch_form" method="post" action="{{route('branches.store')}}" enctype="multipart/form-data">
                                {{@csrf_field()}}
                                <div class="row">
                                    <div class="row form_align">
                                        ...
                                        <div class="input-field col s6">
                                            ...
                                            <input id="address" name="address" type="text" value="{{old('address')}}" data-error=".address">
                                            <div class="address">
                                        ...
                                        <div class="input-field col s6">
                                            ...
                                            <input id="db_password" name="db_password" type="password" value="{{old('db_password')}}" data-error=".db_password">
